...
// Source File Name:   LevelOrderOfGenericTree.java
...
public class LevelOrderOfGenericTree
{
    ...
    public LevelOrderOfGenericTree()
    {
    }
    ...
    public static void levelOrder(Node node)
    {
        ...
        q.add(node);
        for(; !q.isEmpty(); System.out.print((new StringBuilder()).append(((Node)q.poll()).data).append(" ").toString()))
            q.addAll(((Node)q.peek()).children);
