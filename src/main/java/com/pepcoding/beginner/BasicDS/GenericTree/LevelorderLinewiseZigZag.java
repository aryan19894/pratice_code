...
// Source File Name:   LevelorderLinewiseZigZag.java
...
public class LevelorderLinewiseZigZag
{
    private static class Node
    {
        ...
        {
            return (new StringBuilder()).append("[data=").append(data).append("]").toString();
        }
    ...
    public LevelorderLinewiseZigZag()
    {
    }
