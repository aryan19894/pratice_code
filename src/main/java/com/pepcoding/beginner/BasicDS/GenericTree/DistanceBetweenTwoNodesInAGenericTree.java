...
// Source File Name:   DistanceBetweenTwoNodesInAGenericTree.java
...
public class DistanceBetweenTwoNodesInAGenericTree
{
    ...
    public DistanceBetweenTwoNodesInAGenericTree()
    {
    }
    ...
    public static int lca(Node node, int d1, int d2)
    {
        ...
        return ((Integer)p1.get(i + 1)).intValue();
    }
    ...
    public static int distanceBetweenNodes(Node node, int d1, int d2)
    {
        ...
        int i = p1.size() - 1;
        int j;
        for(j = p2.size() - 1; i >= 0 && j >= 0 && p1.get(i) == p2.get(j); j--)
            i--;
