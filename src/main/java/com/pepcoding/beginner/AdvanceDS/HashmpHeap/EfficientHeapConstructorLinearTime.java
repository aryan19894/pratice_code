...
// Source File Name:   EfficientHeapConstructorLinearTime.java
...
public class EfficientHeapConstructorLinearTime
{
    ...
    public EfficientHeapConstructorLinearTime()
    {
    }
